...
export const consoleOuput = (
    ...
    switch (command.toLowerCase()){
        case "help":
            ...
            case "resume": window.open("https://drive.google.com/file/d/1Vkj5GzBlUI4SfwIyh2WLoG1wIJP_C_vS/view?usp=sharing", "_blank");
